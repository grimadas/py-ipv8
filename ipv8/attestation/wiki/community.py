...
class WikiCommunity(Community):
    """
    Community for implement Wikipedia policies [https://en.wikipedia.org/wiki/Wikipedia:Policies_and_guidelines]
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.debug("Starting noodle community with public key: %s",
