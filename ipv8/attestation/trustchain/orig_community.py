...
class OrigTrustChainCommunity(Community):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(OrigTrustChainCommunity, self).__init__(*args, **kwargs)
    ...
    def create_introduction_request(self, socket_address, extra_bytes=b''):
        ...
        return super(OrigTrustChainCommunity, self).create_introduction_request(socket_address, extra_bytes)

    @synchronized
    def create_introduction_response(self, lan_socket_address, socket_address, identifier,
                                     introduction=None, extra_bytes=b''):
        extra_bytes = struct.pack('>l', self.get_chain_length())
        return super(OrigTrustChainCommunity, self).create_introduction_response(lan_socket_address, socket_address,
    ...
    def unload(self):
        ...
        super(OrigTrustChainCommunity, self).unload()

        # Close the persistence layer
        self.persistence.close()


class OrigTrustChainTestnetCommunity(OrigTrustChainCommunity):
    """
